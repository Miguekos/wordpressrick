...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20201223_inversionesarmebo_13add5a846ab8d288932_20201223050919_archive.zip';
    const ARCHIVE_SIZE       = '142183512';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '13add5a-23050919';
    const SECONDARY_PACKAGE_HASH = '377927b-23050919';
    const VERSION            = '3.8.9';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.9==');
        $this->log('----------------------------------------------------');
    ...
    public function log($s, $deleteOld = false)
    {
        static $logfile = null;
        if (is_null($logfile)) {
            $logfile = $this->targetRoot.'/dup-installer-bootlog__'.self::SECONDARY_PACKAGE_HASH.'.txt';
        }
